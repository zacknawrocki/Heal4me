...
export default class ContactMain extends Component {
    ...
    this.setState({
      ...
      if (!this.props.isGroup) {
        this.state.socket.emit('msg', {
          user_id: store.getState().auth.user._id,
          friend_id: this.props.friendItem.friend_id,
          content: this.state.messageText
        });
      } else {
        this.state.socket.emit('msgGroup', {
          user_id: store.getState().auth.user._id,
          friend_id: this.props.roomObj._id,
          content: this.state.messageText
        });
      }
    });
  ...
  getMessageContent = () => {
    this.state.socket.emit('getMessageContent', {
      user_id: store.getState().auth.user._id,
  ...
  getGroupMessage = () => {
    this.state.socket.emit('getGroupMessage', {
      user_id: store.getState().auth.user._id,
      friend_id: this.props.roomObj._id
    })
  };
