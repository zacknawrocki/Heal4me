...
- 1. Type of Commit - Are you adding a file, removing a file, refactoring a file, better documenting a file, etc?
- 2. Files Related to Commit - The files that were changed. If everything below a directory was modified/created/removed, feel free to simple give the directory. The files must listed in [Oxford Comma Format](https://www.grammarly.com/blog/what-is-the-oxford-comma-and-why-do-people-care-so-much-about-it/).
- 3. Finally, describe in more detail what has been done to the file in question.
```
